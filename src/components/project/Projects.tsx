...
const Projects: React.FC<ProjectsProps> = ({ navigation }) => {
  const largeCardData = {
    ...
    content:
      "Lorem ipsum dolor sit amet consectetur. Donec vestibulum quisque tortor nulla sodales integer mattis. Lorem ipsum dolor sit amet consectetur. Donec vestibulum quisque tortor nulla sodales integer mattis.",
    date: "Jul 21st, 2023",
